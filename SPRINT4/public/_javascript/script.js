                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page"
                            href="comunicacao_e_conflitos.html">Comunicação e
                            Conflitos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="pesquisa_e_dados.html">Pesquisa e
                            Dados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="solucoes_sustentaveis.html">Soluções
                            Sustentaveis</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="contato_e_envolvimento.html">Contato
                            e
                            Envolvimento</a>
                    </li>
                </ul>
    ...
    <div class="footer_site">
            ...
            <section id="footer_links" class="footer_section">
                ...
                <ul class="footer_menu">
                    ...
                    <li class="footer_item"><a class="footer_link" href="comunicacao_e_conflitos.html">Comunicação
                            e Conflitos</a>
                    </li>
                    <li class="footer_item"><a class="footer_link" href="pesquisa_e_dados.html">Pesquisa e
                            Dados</a></li>
                    <li class="footer_item"><a class="footer_link" href="solucoes_sustentaveis.html">Soluções
                            Sustentaveis</a>
                    </li>
                    <li class="footer_item"><a class="footer_link" href="contato_e_envolvimento.html">Contato e
                            Envolvimento</a>
                    </li>
                </ul>
            </section>
